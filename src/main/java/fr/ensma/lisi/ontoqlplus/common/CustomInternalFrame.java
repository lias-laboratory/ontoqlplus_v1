...
public abstract class CustomInternalFrame extends JInternalFrame {
	...
	public CustomInternalFrame(String title, boolean resizable, boolean closable, boolean maximizable,
			boolean iconifiable) {
	...
	public abstract void initialize(); // for operations that must be performed after internal frame is realized
}
